(function () {
  ...
  function addBuilderLinks() {
    ...
    heroToolRows.forEach(function (row) {
      ...
      link.href = 'memory-palace-builder.html?pages=' + encodeURIComponent(pageFilename);
    ...
    document.querySelectorAll('.room').forEach(function (room) {
      ...
      link.href = 'memory-palace-builder.html?pages=' + encodeURIComponent(pageFilename) + '&focus=' + encodeURIComponent(roomId);
