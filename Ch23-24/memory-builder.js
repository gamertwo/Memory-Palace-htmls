(function () {
  ...
  var STORAGE_KEY = 'memory-palace-builder-ch23-24-v1';
  var UI_STORAGE_KEY = 'memory-palace-builder-ch23-24-ui-v1';
  ...
  function loadPreset() {
    ...
    state.review.blockId = null; state.review.roomIndex = 0;
    sketchUndoStack = []; sketchRedoStack = [];
    render(true); setStatus('Loaded Chapter 23-24 starter palace.');
  }
  ...
  byId('reset-all-data-button').addEventListener('click', function () {
    showConfirm('Reset all data?', 'Erase every palace from localStorage and reload the Chapter 23-24 starter palace?', function () {
