(function () {
  ...
  var STORAGE_KEY = 'memory-palace-builder-pf-lab4-v1';
  ...
  function loadPreset() {
    ...
    state.review.blockId = null; state.review.roomIndex = 0;
    sketchUndoStack = []; sketchRedoStack = [];
    render(true); setStatus('Loaded the PF Lab 4 blank palace.');
  }
  ...
  byId('reset-all-data-button').addEventListener('click', function () {
    showConfirm('Reset all data?', 'Erase every palace from localStorage and reload the PF Lab 4 blank palace?', function () {
